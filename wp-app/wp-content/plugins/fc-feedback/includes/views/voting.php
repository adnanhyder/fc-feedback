<div class="fc-feedback-form">
    <div class="fc-row">
        ...
        <div class="fc-buttons ">
            <div class="button fc-vote" data-vote-type="positive" data-post-id="<?php echo esc_attr(get_the_ID()); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM164.1 325.5C182 346.2 212.6 368 256 368s74-21.8 91.9-42.5c5.8-6.7 15.9-7.4 22.6-1.6s7.4 15.9 1.6 22.6C349.8 372.1 311.1 400 256 400s-93.8-27.9-116.1-53.5c-5.8-6.7-5.1-16.8 1.6-22.6s16.8-5.1 22.6 1.6zM144.4 208a32 32 0 1 1 64 0 32 32 0 1 1 -64 0zm192-32a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"/>
                </svg>
                <p><?php echo esc_html__( 'Yes', 'fc' ); ?></p>
            </div>
            <div class="button fc-vote" data-vote-type="negative" data-post-id="<?php echo esc_attr(get_the_ID()); ?>">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    <div class="fc-row">
        ...
        <div class="fc-buttons">
            <div class="button">
                ...
                <p><?php echo esc_html__( '70%', 'fc' ); ?></p>
            </div>
            <div class="button">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM176.4 176a32 32 0 1 1 0 64 32 32 0 1 1 0-64zm128 32a32 32 0 1 1 64 0 32 32 0 1 1 -64 0zM160 336H352c8.8 0 16 7.2 16 16s-7.2 16-16 16H160c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/>
                </svg>
                <p><?php echo esc_html__( '30%', 'fc' ); ?></p>
            </div>
        </div>
    </div>
</div>
